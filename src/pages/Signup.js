...
w-full mb-2 sm:mb-12 mt-8 md:mt-6
   ...
   hocus:bg-font hocus:text-gray-200 items-center
      ...
      <Content>
        <MainContainer tw="justify-self-start">
          ...
          <MainContent >
            ...
            <p tw="text-center px-8">Join us now to access inbox automate to increase your leads and emails campaign.</p>
            <FormContainer>
             
              <Form>
                <p>Name:</p>
                <Input tw="mb-8" type="email" placeholder="Enter Your Name" />
                <p>Email:</p>
              ...
              <p tw="mt-0 text-sm text-gray-600 text-center">
