...
export default ({
  ...
  return (
    <Container tw="bg-[#FAF9F5]">
      <TwoColumn tw="pt-8 items-center">
        <Column textOnLeft={textOnLeft}>
          <Card tw="pt-12">
            <TextContent tw="py-8">
              <Solution>Benefits✨</Solution>
              <h2 tw="font-semibold text-black text-4xl">A better price,</h2>
              <h2 tw="font-semibold text-black text-4xl">easy to rise</h2>
              <div tw="pt-4">
                <ul tw="font-medium">
                  <li tw="flex pb-6">
                    <img tw="pr-3" src={circle}></img>
                    There is no need to spend hours adding DNS records such as
                    MX, DMARC, DKIM, and SPF
                  </li>
                  <li tw="flex pb-6">
                    <img tw="pr-3" src={circle}></img>
                    Bulk redirect your domains with just a click, easy to manage
                  </li>
                  <li tw="flex">
                    <img tw="pr-3" src={circle}></img>
                    Logging into every account is not required for Bulk Auth
                    Importing
                  </li>
                </ul>
              </div>
