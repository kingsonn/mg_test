...
const HeaderContent = tw.div`justify-items-center mx-auto`;

const FAQSContainer = tw.dl`mt-12 max-w-5xl relative`;
const FAQ = tw.div`cursor-pointer select-none mt-5 px-8 sm:px-10 py-5 sm:py-8 w-full rounded-lg text-gray-800 hover:text-gray-900 bg-gray-200 hover:bg-[#FFF9E3] transition duration-300`;
          ...
          <FAQSContainer>
            {faqs.map((faq, index) => (
              <FAQ
                ...
                className="group"
                tw="bg-[#FAF9F5] border-2 border-black shadow-shade py-8"
              >
                <Question>
                ...
                >
                                <hr tw="h-px mb-4 bg-gray-200 border-0 dark:bg-blackLight"></hr>
